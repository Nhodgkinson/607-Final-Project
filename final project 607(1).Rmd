...
increase_hw_df<-hos_unicef_df %>%
  subset(Year > 1999 & Year < 2006)%>%
  filter(`COUNTRY, AREA OR TERRITORY` == "Namibia"|`COUNTRY, AREA OR TERRITORY` == "Ghana"|`COUNTRY, AREA OR TERRITORY` == "Rwanda"|`COUNTRY, AREA OR TERRITORY` == "Trinidad and Tobago")
...
same_hw_df<-hos_unicef_df %>%
  subset(Year > 1999 & Year < 2006)%>%
  filter(`COUNTRY, AREA OR TERRITORY` == "Kiribati"|`COUNTRY, AREA OR TERRITORY` == "Lithuania"|`COUNTRY, AREA OR TERRITORY` == "Myanmar"|`COUNTRY, AREA OR TERRITORY` == "Mauritania")
